...
# TODO: Should be able to do this with Python 3.8. Consider upgrading
...
class GaussianProbeTrainer(Trainer):
    ...
    def _train_mle(self):
        ...
        for property_value, property_examples in self._dataset.items():
            ...
            covariance_matrix = (1 / num_samples) * ((embeddings_tensor - mean).T @ (embeddings_tensor - mean))
    ...
    def _get_specification(self, select_dimensions: List[int]) -> Specification:
        return {
            ...
            "covariance_matrices": [x[select_dimensions].T[select_dimensions].T for x in self._covariance_matrices],
        }
