...
class LogisticRegressionProbe(Probe):
    ...
    def _log_prob_class_given_input(self, inputs: torch.Tensor):
        ...
        Returns:
            torch.Tensor: An :math:`N \times K` tensor where :math:`K` is the number of classes. Each entry contains the log probability of a datapoint being assigned as specific class.
        """
