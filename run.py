...
parser.add_argument("--trainer", choices=["adaptive", "fixed", "upperbound", "lowerbound", "qda", "poisson",
                    "conditional-poisson"],
...
parser.add_argument("--adaptive-expected-sampled", type=float, default=50.0, help="Expected number of \
                    dimensions to be sampled by adaptive trainer.")
parser.add_argument("--adaptive-mask-regularization", type=float, default=1.0, help="Weight applied to the \
                    expected sample (L2) regularization parameters of the adaptive trainer. Setting this to \
                    zero will disable expected sample regularization--this will likely cause all dimensions \
                    to be selected by the mask.")
